...
const MappingExistingSuccesScreen = () => {
            ...
            <div className="text-center p-12">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-md">
                  Your product mapping has been saved. You can now view it in
                  the mappings list or create a new one.
                </p>
...
export default MappingExistingSuccesScreen;
